...
import '../quote/cmd.pbenum.dart';

export '../quote/cmd.pbenum.dart';
...
class cmd extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'cmd', package: const $pb.PackageName(_omitMessageNames ? '' : 'cmd'), createEmptyInstance: create)
    ..e<Option>(1, _omitFieldNames ? '' : 'Option', $pb.PbFieldType.OE, protoName: 'Option', defaultOrMaker: Option.OPT_start, valueOf: Option.valueOf, enumValues: Option.values)
