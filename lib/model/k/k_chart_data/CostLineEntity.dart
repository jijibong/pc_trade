...
class CostLineEntity {
   ...
   * @param pri_type
   */
  void initData(List<OHLCEntity> OHLCData, int onePeriod, int twoPeriod, int threePeriod, int fourPeriod, int fivePeriod, int type, int pri_type) {
    CostOne.clear();
    CostTwo.clear();
    CostThree.clear();
    CostFour.clear();
   ...
   * 简单移动平均计算
   */
  void calcSimple(List<OHLCEntity> OHLCData, int onePeriod, int twoPeriod, int threePeriod, int fourPeriod, int fivePeriod, int pri_type) {
    //周期一
   ...
   */
  void calcExponential(List<OHLCEntity> OHLCData, int onePeriod, int twoPeriod, int threePeriod, int fourPeriod, int fivePeriod, int pri_type) {
    double tmpValue = 0.0;
    //周期一
   ...
   * 平滑移动平均计算
   */
  void calcSmoothed(List<OHLCEntity> OHLCData, int onePeriod, int twoPeriod, int threePeriod, int fourPeriod, int fivePeriod, int pri_type) {
    //周期一
    for (int i = 0; i < OHLCData.length; i++) {
      if (i >= onePeriod - 1) {
        double a = 0.0;
