...
class StateGlobal {
  ...
  setLastResolutionGroupValue(String peerId, int currentDisplay, String? value) {
        ...
        wc.setFullscreen(_fullscreen.isTrue).then((_) {
          ...
          if (isWindows && !v) {
            Future.delayed(Duration.zero, () async {
              ...
              final newRect = Rect.fromLTWH(frame.left, frame.top, frame.width + 1, frame.height + 1);
