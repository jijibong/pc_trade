...
const String kOptionRemovePresetPasswordWarning = "remove-preset-password-warning";
...
EdgeInsets get kDragToResizeAreaPadding => EdgeInsets.zero;
...
/// Android constants
const kActionApplicationDetailsSettings = "android.settings.APPLICATION_DETAILS_SETTINGS";
...
const kRequestIgnoreBatteryOptimizations = "android.permission.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS";
