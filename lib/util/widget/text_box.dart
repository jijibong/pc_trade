...
const kMyTextBoxPadding = EdgeInsetsDirectional.fromSTEB(10, 5, 6, 6);
...
class _MyTextBoxSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _MyTextBoxSelectionGestureDetectorBuilder({
    required _MyTextBoxState super.delegate,
  }) : _state = delegate;

  final _MyTextBoxState _state;
...
class MyTextBox extends StatefulWidget {
  ...
  const MyTextBox({
    ...
    this.highlightColor,
    this.unfocusedColor,
    this.padding = kMyTextBoxPadding,
    this.placeholder,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty<EdgeInsetsGeometry>(
        'padding',
        padding,
        defaultValue: kMyTextBoxPadding,
      ))
      ...
      ..add(FlagProperty('selectionEnabled', value: selectionEnabled, defaultValue: true, ifFalse: 'selection disabled'))
      ...
      ..add(DiagnosticsProperty<bool>('enableIMEPersonalizedLearning', enableIMEPersonalizedLearning, defaultValue: true))
      ..add(DiagnosticsProperty<SpellCheckConfiguration>('spellCheckConfiguration', spellCheckConfiguration, defaultValue: null));
  }
...
class _MyTextBoxState extends State<MyTextBox>
    with RestorationMixin, AutomaticKeepAliveClientMixin<MyTextBox>
  ...
  late _MyTextBoxSelectionGestureDetectorBuilder _selectionGestureDetectorBuilder;
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder = _MyTextBoxSelectionGestureDetectorBuilder(
      delegate: this,
    );
  ...
  @override
  void didUpdateWidget(MyTextBox oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final spellCheckConfiguration =
        widget.spellCheckConfiguration != null && widget.spellCheckConfiguration != const SpellCheckConfiguration.disabled()
            ? widget.spellCheckConfiguration!
                .copyWith(misspelledTextStyle: widget.spellCheckConfiguration!.misspelledTextStyle ?? MyTextBox.fluentMisspelledTextStyle)
      ...
      child: RepaintBoundary(
        child: UnmanagedRestorationScope(
          ...
          child: EditableText(
            ...
            magnifierConfiguration: widget.magnifierConfiguration ?? MyTextBox._fluentMagnifierConfiguration,
          ...
          color: _effectiveFocusNode.hasFocus
              ...
              : !enabled
                  ...
                  : widget.unfocusedColor ??
                      (themeData.brightness.isLight ? const Color.fromRGBO(0, 0, 0, 0.45) : const Color.fromRGBO(255, 255, 255, 0.54)),
